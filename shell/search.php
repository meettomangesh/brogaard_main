...
$found = array_sum($totalIDx); // TOTAL valid images found
    ...
    <?php
		...
		if($HDPhotoExist != 0){
			...
			if( empty( $_GET['st'] ) ){
				if ( ($_SESSION['folderaccess'] == 2) OR ($_SESSION['folderaccess'] == 3 ) ){	//Arafin: set peimission to see gallery
		?>
		<p class="desc-paragraph"><a href="http://www.brogaard.com/shell/search.php?s=<?php echo $_GET['s']; ?>&st=h"><img src="<?php echo URL_USER; ?>pages-resources/images/icon_gallery_HD.png" class="img-class-se-kun" /> Se kun HD-billeder</a></p> 
		<?php
				}
			}else{
		?>
		<p class="desc-paragraph"><a href="http://www.brogaard.com/shell/search.php?s=<?php echo $_GET['s']; ?>"><img src="<?php echo URL_USER; ?>pages-resources/images/icon_gallery.png" height="18px" width="18px" /> Vis alle billeder der indeholder <?php echo $_GET['s']; ?></a></p> 	
		<?php } ?>
		<?php
			}
		}
