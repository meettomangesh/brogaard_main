                     ...
                     <div class="send-message" >
                        ...
                        <div class="comment-fieldbox" style="margin-bottom:20px;">
                             <form method="post" action="" id="login-form">
                                ...
                                <div class="checkbox">
                                <!-- <label for="rememberme"><?php echo lang('keepme_loggedin'); ?>--><label> Remember Me<input type="checkbox" value="" id="rememberme" name="rememberme"></label>
                                </div>
                            ...
                            <p class="mt-20">
                             ...
                             <p style="color:#fff;">Login requires cookies to be enabled.</p>
                        </div>
                     </div>
                    </div>
