...
?>
<style type="text/css">
div.sbox-container { float:right; padding-right:420px; height:40px; background: #5e5e5e url('<?php echo URL_USER; ?>pages-resources/images/search-bg.jpg') repeat-x; width:308px;} 
...
input.sbox { border:none; background:transparent; width:200px; color:#333333; padding:4px 0 0 10px; font-size:9pt; } 
</style>
...
<div class="menu_container" style="margin-top:-43px;">
<p class="menuitems">
