               ...
               <!--<p class="lineTitle1"> <h2>SERVICES</h2><!--</p>-->
                  ...
                  <div class="send-message" >
                   <h4> <span style="border-bottom:1px solid #e8e8e8;padding-bottom: 3px; margin-bottom:12px;">Virksomhedsportrættet</span></h4>
                    <p>Til hjemmesider, udbudsmateriale, plancher, bannere, brochurer, apps m.m. skal der bruges billeder - mange billeder. En hurtig løsning er at gribe til stocksfotos - det ser hurtigt glat og strømlinet ud. Den lette løsning er bare sjældent den bedste. Jeg er dygtig til at sætte mig ind i dig og din virksomhed. At få “almindelige” menneskers ualmindelige kvaliteter frem i fotografiet og hjælpe dig med at dine medarbejdere og din virksomhed for et unikt og professionelt udtryk. </p>
