...
.social{width:30px; z-index:99999; position:fixed; right:2px; top:38.5%;}
...
.social a:hover{ background:#BF191F;}
               ...
               <div class="contact-area">
                    ...
                    <div class="contact-info">
                        ...
                        <div class="contact-details">
                        	<ul>
                            	<li><!--address:--> <p style="font-family:Verdana; font-size:13px;">STUDIO: 
...
<br/>
   ...
   <!--<span>Refshalevej 169 A, 1. DK - 1432 Cph. K</span> <br>--></li>
                        ...
                        <div class="contact-textarea">
                            ...
                            <p style="font-family:Verdana; font-size:13;"> Refshaleøen er et rustikt og fotogent område med nem parkering og en mængde rekreative muligheder. Firmafotografering kan derfor nemt kombineres med teambuilding-møde her hos mig eller fælles oplevelser hos naboerne Mikkeler, Københavns Klatrecenter, Halvandet, Reffn eller La Banchina.
