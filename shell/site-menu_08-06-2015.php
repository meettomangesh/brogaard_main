...
<a class="<?php active_menu('galleryindex.php'); ?> alpha" href="http://www.brogaard.com/portfolio/index.php"><?php echo lang('portfolio'); ?></a><a class="<?php active_menu('info.php'); ?>" href="<?php echo URL_USER; ?>info.php"><?php echo lang('royal'); ?></a><a class="<?php active_menu('about.php'); ?>" href="<?php echo URL_USER; ?>about.php"><?php echo lang('scrapbook'); ?></a><a class="<?php active_menu('services.php'); ?>" href="<?php echo URL_USER; ?>services.php"><?php echo lang('services'); ?></a><a class="<?php active_menu('contact.php'); ?>" href="<?php echo URL_USER; ?>contact.php"><?php echo lang('contact'); ?></a><a class="menuitem" href="http://www.mosthigh.dk" title="<?php echo lang('most_high_title'); ?>" target="_blank"><?php echo lang('most_high'); ?><img src="<?php echo URL_USER; ?>pages-resources/brogaard/arrowout.gif" alt="" align="absbottom" /></a><a class="menuitem omega" href="<?php echo URL_USER; ?>logout.php"><?php echo lang('logout'); ?></a>
</p></div>
