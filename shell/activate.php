                     ...
                     <div class="send-message" >
                        ...
                        <div class="comment-fieldbox" style="margin-bottom:20px;">
                             <form method="post" action="" id="activate-form">
                                ...
                                <input id="activationkey" class="input-email" type="text" name="activationkey" placeholder="Activation Code" required />
                                                                                          
                                <div class="comment-active" style="padding:0px 5px;">
                                  
                                    <input style="float:left;z-index:9999; width:100%; border-radius:5px!important; font-family:'Lucida Grande', 'Helvetica Neue', 'Helvetica', 'Arial', 'Verdana', 'sans-serif';" id="submit" class="submit-button" type="submit" value="<?php echo lang('send'); ?>"/>
                                </div>
                            ...
                            <p class="mt-20">
                                <a style="color:#fff;font-weight:500;" href="<?php echo URL_USER; ?>login.php"> <?php echo lang('click_here_to_login'); ?> </a> 
                            </p>
                         </div>
                     </div>
                    </div>
