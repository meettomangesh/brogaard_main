                   ...
                   <div class="contact-area">
                	...
                	<!--Send Message Start-->
                        ...
                        <!--./pages-resources/php/formtoeamil_new.php-->
                            ...
                            <div class="form-div">
                                <input id="name" class="input-email" type="text" name="first_name" placeholder="First name<?php //echo lang('first_name'); ?> * " value="<?php echo ( isset($firstname)?$firstname:'' ); ?>" required>
                                <input id="name" class="input-phone" type="text" name="last_name" value="<?php echo ( isset($lastname)?$lastname:'' ); ?>" placeholder="Surname <?php //echo lang('last_name'); ?> *" >
