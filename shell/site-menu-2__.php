<link rel="stylesheet" href="http://www.brogaard.com/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="http://www.brogaard.com/assets/css/vendors/bootstrap.css" >
<!--<link rel="stylesheet" type="text/css" href="http://www.brogaard.com/assets/css/style.css">-->
<link href="http://www.brogaard.com/css/stylemenu.css" rel="stylesheet">
<link rel="stylesheet" type="text/css" href="http://www.brogaard.com/css/default.css" />
<link rel="stylesheet" type="text/css" href="http://www.brogaard.com/css/component.css" />
 <link rel="stylesheet" type="text/css" href="http://www.brogaard.com/assets/css/vendors/Pe-icon-7-stroke.css">
    ...
    <nav class="navbar navbar-inverse">
      <div class="container">
        ...
        <div class="navbar-header">
         ...
         <!--<li>-->
          <a class="navbar-brand" href="http://www.brogaard.com/index.php"> <img src="http://www.brogaard.com/assets/img/logo.png"></a>
          <!--</li>
          </ul>-->
        </div>
...
?>
             <div id="nv2" style="display:none;">
                <li class="d-none"><a href="<?php echo URL_USER; ?>edit_account.php"><img src="http://www.brogaard.com/images/ic_account.png" title="Din konto"  /></a></li>
                <li class="d-none"><a href="<?php echo $clientGalleryHome.'/pdf.php'; ?>"><img src="http://www.brogaard.com/images/ic_pdf_1.png" title="PDF" /></a></li>
				<li class="d-none"><a href="<?php echo $clientGalleryHomeHD; ?>"><img src="http://www.brogaard.com/images/download-gray.png" title="Download"> </a></li>
                <li class="d-none"><a class="l-1" href="<?php echo $clientGalleryHome; ?>"><img src="http://www.brogaard.com/images/ic_commitee.png" title="Udvalg"></a></li>
               </div>
              <?php
}
	  ?>
...
?>
      <div id="afl-menu" class="container-fluid" style="padding:0!important; display:block;">
         <ul id="nav2"  class="navbar-nav nav"><!--id="nav2"-->
            <div >
                <li><a href="<?php echo URL_USER; ?>edit_account.php"><img src="http://www.brogaard.com/images/ic_account.png" title="Din konto" /></a></li>
                <li><a href="<?php echo $clientGalleryHome.'/pdf.php'; ?>" alt="PDF"  ><img src="http://www.brogaard.com/images/ic_pdf_1.png" alt="PDF" title="PDF" /></a></li>
				<li><a href="<?php echo $clientGalleryHomeHD; ?>" ><img src="http://www.brogaard.com/images/download-gray.png" title="Download"></a></li>
                <li><a href="<?php echo $clientGalleryHome; ?>"><img src="http://www.brogaard.com/images/ic_commitee.png" title="Udvalg"></a></li>
            <div>
         </ul>
      </div>
      <?php
...
<script src="http://www.brogaard.com/js/classie.js"></script>
<script src="http://www.brogaard.com/js/uisearch.js"></script>
<script>
	new UISearch( document.getElementById( 'sb-search' ) );
</script>

<script type="text/javascript" src="http://www.brogaard.com/assets/js/vendors/bootstrap.min.js"></script>
<script type="text/javascript" src="http://www.brogaard.com/js/jquery.min.js"></script>
