    ...
    <tr>
      <td>
		  ...
		  <table width="600" border="0" bordercolor="#000000">
              <tr>
                <td colspan="2" align="left"><p align="left"  style="color: #ffffff; font-family: verdana; font-size: 12px;"><a href="login.html">Klik her for login</a></td>
              </tr>
			  <tr>
                <td colspan="2" align="left" height="10"></td>
              </tr>
			  <tr>
                <td colspan="2" align="left" height="10">Your account has been created successfully.</td>
              </tr>
			  <tr>
                <td colspan="2" align="left" height="10"></td>
              </tr>
              <tr>
                <td colspan="2" align="left"><p align="left"  style="color: #ffffff; font-family: verdana; font-size: 12px;"><a href="royal.html">Click here to go back previous page</a></td>
              </tr>
            </table>
          </div>
