...
#comp{width:100%; float:left; display:none;}
   ...
   .rdio-group span{float:left;margin: 6px 10px 0 10px; font-size:17px;}
   .rdio-group .radio{float:left; width:16%; margin-bottom:0!important;}
   ...
   @media screen and (max-width:1024px){.rdio-group .radio {float: left;width: 23%;}.regi, .atract {float: left;width: 74%;}#g1, #g2 {width: 15%;}#g3, #g4 {width: 25%;}.checkbox{padding-left: 9px;}#canbest {width: 36%!important;}.comment-fieldbox textarea.input-textarea{width:36%!important}}
   ...
   @media screen and (max-width:768px){.form-div {width: 93%;}input[type="text"]#Cname {width: 40%;}.comment-fieldbox textarea.input-textarea {width: 41%;height:105px;}select#best {width: 21%;}.pic{float: left;width: 69%;} input[type='file'] {width: 52%;}.rdio-group .radio {float: left;width: 29%;}.regi, .atract {float: left;width: 71%;}.rdio-group #g1, .rdio-group #g2 { width: 18%!important;}#g3, #g4 {width: 30%;}.radio, .checkbox {padding-left: 16px;}.contact-info{border-top:0!important}.aboutus-content h2{margin-top:0;}.demo-in {width: 11%!important;}#canbest {width: 41%!important;}.comment-fieldbox textarea.input-textarea{width:41%!important}}
   ...
   @media screen and (max-width:568px){#g1, #g2 {width: 25%!important;}.demo-in {width: 16%!important;}#g3, #g4 { width: 44%!important;} input[type='radio']{ {width: 16px!important;}.comment-fieldbox input{width:99%!important;}.comment-fieldbox textarea.input-textarea { width: 52%!important;height: 85px;}#canbest {width: 50%;}#canbest {width: 50%!important; }}
    ...
    @media screen and (max-width:480px){.comment-fieldbox input{width: 79%;}.regi {float: left;width: 52%;}.rdio-group .radio {float: left; width: 57%!important;} input[type='radio']{width:16px!important;}.rdio-group #g1,.rdio-group #g2{width:25%!important;}#g3, #g4 {width: 45%!important;}input[type="text"]#Cname {width: 79%!important;}select#best {width: 33%;}.bd{float: left;width: 58%;}select#dd, select#mm, select#yy {width: 100%;margin: 10px 0px;}.wrapper.boxstyle{width: 89% !important;}.box-container {padding: 0px 15px!important;}.pic {float: left;width: 90%;}.demo-in {width: 17%!important;}#canbest {width: 44%;margin-bottom: 11px;}.comment-fieldbox textarea.input-textarea{width:79%!important;}}   
                            ...
                            <!-- <div class="bd">-->
                               ...
                               <!-- </div>-->
                                ...
                                <span class="w-100-mb-15">Can Best:</span>
                                  ...
                                  <div class="checkbox" style="margin-top:15px!important;">
                                  ...
                                  <div class="comment-active" style="margin-top:0px;">
