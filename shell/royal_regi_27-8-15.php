                	...
                	<!--Send Message Start-->
                        ...
                        <!--./pages-resources/php/formtoeamil_new.php-->
                            ...
                            <div class="form-div">
                                ...
                                <input id="name" class="input-phone" type="text" name="lastname" value="<?php echo ( isset($lastname)?$lastname:'' ); ?>" placeholder="Surname <?php //echo lang('last_name'); ?> *" >
                                ...
                                <input id="password" class="input-email" type="password" name="password" value="" placeholder="Password <?php //echo lang('password'); ?> *" required />
                                 ...
                                 <div class="checkbox">
                                   <label> <input type="checkbox" id="newsletter" checked="checked" name="newsletter" value="1">Get newsletter <?php //echo lang('join_newsletter'); ?></label>
                                  </div>                                
