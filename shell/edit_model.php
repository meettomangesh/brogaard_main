...
$_SESSION[first_name] 	= $firstname;
	...
	if(!empty($_FILES[images][name][0]))
	{
		...
		if(!empty($MyImages))
		{
			...
			$sql2 = "UPDATE authorize_details SET modelimages = '$ImageStr' WHERE authorize_id = '$hiddenuserid'";
			$result2 = mysql_query($sql2) or die ("Error in query: $sql2. ".mysql_error());
		}
...
if(!empty($modelimages)) {
	...
	while(list(,$vi) = each($MyImages))	{
		$images .= "<td align=center style=\"padding-bottom:10px;padding-top:10px;\"><img src=\"/shell/modelimages/$vi\" width=100 height=100></td>";
		$mi++;
	}
}
	$images .= "</tr>\n";
...
<div id="page">
	...
	<div class="copy" style="float:left; width: 512px; height: 1300px;">
              ...
              <tr>
                ...
                <td align="left"><input <?=$newsselected?> id="sub_newsletter" name="sub_newsletter" type="checkbox" value="1" /></td>
					...
					<tr>
						...
						<td align="left"><font size="1" face="Tahoma"><input type="radio" name="modelgender" value="male" <? if ($modelgender == 'male') { echo 'checked'; } ?>/>Male <input type="radio" name="modelgender" value="female" <? if ($modelgender == 'female') { echo 'checked'; } ?>/>Female</font></td>
					</tr>
					<tr>
						<td align="left">Date of Birth:</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modelbirth" value="<?=$modelbirth?>"></font></td>
					</tr>					
					<tr>
						<td align="left">Skin Color:</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modelskincolor" value="<?=$modelskincolor?>"></font></td>
					</tr>
					<tr>
						<td align="left">Eye Color:</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modeleyecolor" value="<?=$modeleyecolor?>"></font></td>
					</tr>
					<tr>
						<td align="left">Hair Color:</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modelhaircolor" value="<?=$modelhaircolor?>"></font></td>
					</tr>
					<tr>
						<td align="left">Height (cm):</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modelheight" value="<?=$modelheight?>"></font></td>
					</tr>
					<tr>
						<td align="left">Type:</td>
						<td align="left"><input type="radio" name="modeltype" value="Only commercial jobs" <? if ($modeltype == 'Only commercial jobs') { echo 'checked'; } ?>/>Only commercial jobs<br><input type="radio" name="modeltype" value="Commercial and non-cmmercial jobs" <? if ($modeltype == 'Commercial and non-cmmercial jobs') { echo 'checked'; } ?>/>Commercial and non-commercial jobs</td>
					</tr>
					<tr>
						<td align="left">Address:</td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modeladdress" value="<?=$modeladdress?>"></font></td>
					</tr>
					<tr>
						<td align="left">City: <span class="required">*</span></td>
						<td align="left"><font size="1" face="Tahoma"><input type="text" name="modelcity" value="<?=$modelcity?>"></font></td>
					</tr>
					<tr>
						...
						<select name="modelavailability">
							<option value=""></option>
							<option value="Before noon" <? if ($modelavailability == 'Before noon') { echo 'selected'; } ?>>Before noon</option>
							<option value="After noon" <? if ($modelavailability == 'After noon') { echo 'selected'; } ?>>After noon</option>
							<option value="Evening" <? if ($modelavailability == 'Evening') { echo 'selected'; } ?>>Evening</option>
							<option value="Doesn't matter"  <? if ($modelavailability == 'Doesn\'t matter') { echo 'selected'; } ?>>Doesn't matter</option>
						</select>
						</font></td>
					</tr>
					<tr>
						<td align="left">Comments:</td>
						<td align="left"><font size="1" face="Tahoma"><textarea rows="4" cols="30" name="modelcomments"><?=$modelcomments?></textarea></font></td>
					</tr>
					<tr>
