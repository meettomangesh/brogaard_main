<?php
// localhost url
//$siteurl = "http://".$_SERVER['HTTP_HOST']."/brogaard_new/";
// server url 
...
.pic{float: left;
  width: 40%;}
.aboutus-content p{font-size:15px;font-family:"Lucida Grande", "Helvetica Neue", "Helvetica", "Arial", "Verdana", "sans-serif","Myriad Set Pro"; float:left;}
...
#comp{width:100%; float:left; display:none;}
   ...
   .rdio-group span{float:left;margin: 7px 10px 0 10px; font-size:17px;}
   .rdio-group .radio{float:left; width:14%;}
   ...
   .checkbox{float:left;margin-top:9px!important;margin-left: 8px;}
   .comment-active{width:100%; float:left;}
   .form-div{width:78%; float:left;}
   h3,h4{font-family:"Lucida Grande", "Helvetica Neue", "Helvetica", "Arial", "Verdana", "sans-serif";}
   .checkbox input[type="checkbox"]#custom, .checkbox input[type="checkbox"]#sply{
	...
	.comment-fieldbox textarea.input-textarea{width:36%; margin-left:1%; float:left; }
	.box{display:none;}
	...
	.demo-in{width: 8%;float: left; margin:0 10px;}
   @media screen and (max-width:1024px){.rdio-group .radio {float: left;width: 21%;}.regi, .atract {float: left;width: 74%;}#g1, #g2 {width: 14%;}#g3, #g4 {width: 23%;}.checkbox{padding-left: 9px;}}
   @media screen and (max-width:768px){.form-div {width: 93%;}input[type="text"]#Cname {width: 40%;}.comment-fieldbox textarea.input-textarea {width: 41%;height:105px;}select#best {width: 21%;}.pic{float: left;width: 69%;} input[type='file'] {width: 52%;}.rdio-group .radio {float: left;width: 24%;}.regi, .atract {float: left;width: 71%;}.rdio-group #g1, .rdio-group #g2 { width: 18%!important;}#g3, #g4 {width: 26%;}.radio, .checkbox {padding-left: 16px;}.contact-info{border-top:0!important}}
   ...
   @media screen and (max-width:640px) {.rdio-group#g1, .rdio-group#g2 {width: 23%!important;}.demo-in {width: 16%!important;}#g3, #g4 {width: 37%!important;}.rdio-group .radio {float: left;width: 52%;}.form-div {width: 100%;}input[type="text"]#Cname {width: 50%;}.comment-fieldbox textarea.input-textarea { width: 52%!important;height: 85px;}select#dd, select#mm, select#yy {width: 100%;}select#best{width: 28%;}input[type='file']{width: 60%;}.regi{float: left;width: 58%;}.atract {float: left;width: 63%!important;}.rdio-group span{width:100%;}.radio{padding-left:9px;}.checkbox {padding-left: 0px;}}
   @media screen and (max-width:533px){.rdio-group #g1, .rdio-group #g2 {width: 23%!important;}.demo-in {width: 18%!important;}}
   @media screen and (max-width:600px){.rdio-group #g1, .rdio-group #g2 {width: 19%!important;} input[type='radio']{ {width: 16px!important;}.comment-fieldbox input{width:99%!important;}.comment-fieldbox textarea.input-textarea { width: 52%!important;height: 85px;}}
   @media screen and (max-width:568px){#g1, #g2 {width: 25%!important;}.demo-in {width: 14%!important;}#g3, #g4 { width: 40%!important;} input[type='radio']{ {width: 16px!important;}.comment-fieldbox input{width:99%!important;}.comment-fieldbox textarea.input-textarea { width: 52%!important;height: 85px;} }
    @media screen and (max-width:480px){.comment-fieldbox input{width: 79%;}.regi {float: left;width: 52%;}.rdio-group .radio {float: left; width: 52%!important;} input[type='radio']{width:16px!important;}.rdio-group #g1,.rdio-group #g2{width:20%!important;}input[type="text"]#Cname {
  width: 59%!important;}select#best {width: 33%;}.bd{float: left;width: 58%;}select#dd, select#mm, select#yy {width: 100%;margin: 10px 0px;}.wrapper.boxstyle{width: 89% !important;}.box-container {padding: 0px!important;}.pic {float: left;width: 90%;}}
...
<header>
 ...
 <div class="navbar navbar-custom navbar-fixed-top" role="navigation" style="background:rgb(105,105,105)!important; opacity:0.9 !important;">
    ...
    <!--Header End-->
        	...
        	<div class="container background" style="background:#fff;">
                                ...
                                <span> Register yourself as <?php //echo lang('registeras'); ?>: *</span>
                                 <div class="regi">
                                  <div class="radio">                                 
                                    ...
                                    <label for="r1">Private <?php //echo lang('private'); ?> <span></span></label>  
                                   </div>
                                   <div class="radio">
                                    <input  type="radio" value="company" name="registeras" id="r2">
                                    <label for="r2">Company <?php //echo lang('company'); ?><span></span>  </label>
                                   </div>
                                   <div class="radio">
                                   <input type="radio" value="model"  name="registeras" id="r3"> 
                                    <label for="r3">Model <?php //echo lang('model'); ?><span></span> </label>
                                   </div>
                                   </div>
                                </div>
                               ...
                               <!-- </div>-->
                                ...
                                <span class="w-100-mb-15">Can Best:</span>
                                  ...
                                  <input type="checkbox" value="1" id="sub_newsletter" checked="checked" name="sub_newsletter">
                                    <label for="sub_newsletter">Get newsletter<span></span><?php //echo lang('join_newsletter'); ?></label>
                                    
                                  </div>                                
                                  <div class="comment-active">
                                    <!--<span>All fields are mandatory.</span>-->
                                    
                                    <input class="submit-button" type="submit" id="submitform" name="submitform" value="SUBMIT" style="border-radius:5px; !important"><?php //echo lang('register'); ?>
                                </div>
