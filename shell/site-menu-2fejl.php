...
echo '<link rel="stylesheet" type="text/css" media="screen" href="'.URL_USER.'pages-resources/css/menu.css" />'."\n";
...
?>
<style type="text/css">
div.sbox-container { float:right; padding-right:420px; height:40px; background: #5e5e5e url('<?php echo URL_USER; ?>pages-resources/images/search-bg.jpg') repeat-x; } 
div.sbox-wrap { width:235px; background: transparent url('<?php echo URL_USER; ?>pages-resources/images/search-box1.png') 16px 8px no-repeat; padding: 7px; border:none; }
input.sbox { border:none; background:transparent; width:200px; color:#333; padding:4px 0 0 10px; font-size:9pt; } 
</style>
...
<div class="menu_container" style="margin-top:-43px;"><p class="menuitems">
