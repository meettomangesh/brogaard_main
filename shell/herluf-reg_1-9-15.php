...
input[type='radio']:checked { background-position: 0 0; }
 input[type=text]:focus, input[type=password]:focus, textarea:focus {
   ...
   .checkbox{float:left;margin-top:15px!important;margin-left: 8px; width:100%;}
                   ...
                   <div class="contact-area">
                	...
                	<!--Send Message Start-->
                        ...
                        <!--./pages-resources/php/formtoeamil_new.php-->
                            ...
                            <div class="form-div">
                                <input id="name" class="input-email" type="text" name="firstname" placeholder="First name<?php //echo lang('first_name'); ?> * " value="<?php echo ( isset($firstname)?$firstname:'' ); ?>" required>
                                <input class="input-phone" type="text" name="lastname" id="lastname" value="<?php echo ( isset($lastname)?$lastname:'' ); ?>" placeholder="Surname <?php //echo lang('last_name'); ?> *" >
                                 <input id="email_address" class="input-email" type="email" name="email_address" value="<?php echo ( isset($email_address)?$email_address:'' ); ?>" placeholder="E-mail <?php //echo lang('email'); ?> *" data-error="Bruh, that email address is invalid" required>
                                  <input id="reemail_address" class="input-email" type="email" name="reemail_address" value="<?php echo ( isset($reemail_address)?$reemail_address:'' ); ?>" placeholder="Repeat E-mail <?php //echo lang('email_repeat'); ?>  *" data-error="Bruh, that email address is invalid" required>
                                ...
                                <input id="password" class="input-email" type="password" name="password" value="" placeholder="Password <?php //echo lang('password'); ?> *" required />
                                
                                 <input id="repassword" class="input-phone" type="password" name="repassword" placeholder="Repeat Password <?php //echo lang('password_repeat'); ?> *" required>
                                 ...
                                 <div class="checkbox">
                                   <label> <input type="checkbox" id="newsletter" checked="checked" name="newsletter" value="Yes">Get newsletter <?php //echo lang('join_newsletter'); ?></label>
                                  </div>                                
                                  <div class="comment-active">
                                    <!--<span>All fields are mandatory.</span>-->
                                    <input class="submit-button" type="submit" name="submit" id="submit" value="SUBMIT <?php //echo lang('register'); ?>" style="border-radius:5px; !important">
                                </div>
