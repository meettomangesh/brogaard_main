 ...
 input[type=text]:focus, input[type=password]:focus, textarea:focus {
   ...
   .checkbox input[type="checkbox"]#custom, .checkbox input[type="checkbox"]#sply{
	...
	.box{display:none;}
	 ...
	 .ic_cv{ float:right; margin-right:30px;}
	 .tooltip11 .title {
			position: absolute;
			top: 102px;
			color: #fff;
   ...
   @media screen and (max-width:1024px){.rdio-group .radio {float: left;width: 16%;}.regi, .atract {float: left;width: 74%;}.ic_cv{ margin-right:18px!important;}}
   @media screen and (max-width:768px){.form-div {width: 93%;}input[type="text"]#Cname {width: 40%;}.comment-fieldbox textarea.input-textarea {width: 41%;height:105px;}select#best {width: 21%;}.pic{float: left;width: 69%;} input[type='file'] {width: 52%;}.rdio-group .radio {float: left;width: 19%;}.regi, .atract {float: left;width: 71%;}.ic_cv{ margin-right:16px!important;}}
   @media screen and (max-width:736px){.ic_cv{ margin-right:15px!important;}}
   @media screen and (max-width:667px){.ic_cv{ margin-right:11px!important;}}
   ...
   @media screen and (max-width:600px){ input[type='radio']{ {width: 16px!important;}.comment-fieldbox input{width:99%!important;}.comment-fieldbox textarea.input-textarea { width: 52%!important;height: 85px;}.ic_cv{ margin-right:12px!important;}}
  ...
  width: 59%!important;}select#best {width: 33%;}.bd{float: left;width: 58%;}select#dd, select#mm, select#yy {width: 55%;margin: 10px 0px;}}
   @media screen and (max-width: 414px){.ic_cv{ margin-right:-2px!important;}}
    @media screen and (max-width: 384px){.ic_cv{ margin-right:-3px!important;}}
  @media screen and (max-width: 375px){.ic_cv{ margin-right:0px!important;}}
  @media screen and (max-width: 320px){.rdio-group .radio { float: left;width: 76%!important;}input[type="text"]#Cname {width: 85%!important;}.comment-fieldbox textarea.input-textarea {width: 87%!important;height: 77px;}.comment-fieldbox input { width: 95%;}.rdio-group #g1, .rdio-group #g2 {width: 32%!important;}.ic_cv{ float:right; margin-right:-4px;}}
        ...
        <div class="wrapper boxstyle" style="background: rgba(0,0,0,0.4); border-radius:5px;">
           ...
           <!--Blog Lists and Sidebar-->
            <section class="box-container" style="background:none !important;">
               ...
               <div class="ic_cv">
    <span class="tooltip11" title="Since 1992, Steen Brogaard served as first HRH Crown Prince Frederik and later as HRH Prince Joachim's personal photographer by both private and official occasions. This work has over the years led to many trips, exhibitions, books, and not to mention countless entries in Danish and foreign magazines."><img src="http://www.brogaard.com/images/ic_info_royal.png"></span>
               </div>
