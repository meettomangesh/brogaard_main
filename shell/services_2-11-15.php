...
#comp{width:100%; float:left; display:none;}
   ...
   .checkbox input[type="checkbox"]#custom, .checkbox input[type="checkbox"]#sply{
	...
	.radio label, .checkbox label{padding-left: 7px!important;}
...
CV</a>
              <!--<a onClick="showhide()" href="#">CV</a>-->
              </div>

<div id="div_name2" style="display:none;margin:15px 15px 0px 15px; position:fixed; width:700px; height:298px; right:2%; bottom:16%; z-index:9999; background:  url(../images/down-arrow-new.png) bottom right no-repeat;">
<div id="cd" style="padding-bottom:10px; background:#757575; border-radius:5px;padding:5px;">  
<a id="close" onclick="document.getElementById('div_name2').style.display='none';return false;" href=""style="text-decoration:none; float:right; padding:4px 9px; background:#ccc;color:#BF191F; border-radius:25px; font-size:13px; font-weight:bold;">X</a><br>
Selvlært fotograf siden 1984 for bl.a. Ugeavisen København og Greenpeace <br> Udlært pressefotograf på Billed Bladet i 1991 <br> Selvstændig på 5C siden 1991<br> Udvalgte kunder gennem årene: Agenzy, Alcon A/S, Bane Danmark, Bellevue Teatret, Bruun & Hjejle, Care, Coop, DR, DSB, DTU, Düsseldorfer Schauspielhaus, EG, Egmont, Egmontfonden, Erhvervsstyrelsen, Folketinget,  Forlæggerforeningen, Fullrate, Gads Forlag, Grevinde Alexandra, Grevinde Danner, Hello Magazine,  Herlufsholm, Holm Kommunikation, IBM, Kongehuset, Lett Advokater, LIFE Magazine, Logitech, Oracle, McDonalds, Månedsmagasinet IN, Nationalbanken, NCC, Netcompany, Nordea, Nordisk Film, Sjælsø, Søren Østergaard, Søs Fenger, Pointwork, Post Greenland, Psykologi, Region Hovedstaden, Rigshospitalet, Rockwool, Røde Kors, Salon Aqua, Scandinavian Branding, Slots og Ejendomsstyrelsen, Spencer & Stuart, TDC, TV2, Udenrigsministeriet, Unicef, Vandkunstens Forlag, WHO, Zirkus Nemo, Øresundskonsortiet, Ørkenens Sønner m.fl. <br> Udstillet på bl.a.  Frederiksborg Nationalhistoriske Museum, Den Sorte Diamant, Dansk Kulturinstitut i Edinburgh, Nationalteatret i Riga, Nationalbiblioteket i Tallin, Dansk Kulturinstitut i Ungarn og den danske ambassade i Chengdu, Kina
</div>
</div>
            ...
            <section class="box-container" style="background:none !important;">
               ...
               <!--<p class="lineTitle1"> <h2>SERVICES</h2><!--</p>-->
                  ...
                  <div class="send-message" >
                   <h4> <span style="border-bottom:1px solid #e8e8e8;padding-bottom: 3px; margin-bottom:12px;">Virksomhedsportrættet</span></h4>
                    <p>Til hjemmesider, udbudsmateriale, plancher, bannere, brochurer, apps m.m. skal der bruges billeder - ofte mange. Mange tror, at det er billigere at bruge stock-fotos end en rigtig levende fotograf, og det er det også. Men måske ikke så meget billigere, som I forestiller jer. For hvis I hyrer mig, bliver alle fotografierne afspejlinger af den hverdag i virksomheden, I gerne vil formidle til jeres kunder, forretningsforbindelser og andre stakeholders. Og det bliver fotografier i en kvalitet, som kan blæses op i kæmpeformat og hænges op i foyeren. </p>
                    <p>I vil fremover have et katalog af billeder, som I kan tage fra, hver gang der skal bruges nye. Alle billederne vil klæde hinanden og være i topkvalitet og vil til enhver anledning kunne genanskaffes via min hjemmeside. Vi indgår helt klare aftaler om honorar og brug af billederne, så ingen skal være i tvivl.</p>
                    <h4 style="font-weight:300;">Ledelsen</h4>
                   <p>Det er vigtigt, at alle medlemmer af ledelsen fremstår professionelle og venlige. I disse social-media tider er der en overhængende risiko for, at potentielle kunder, kolleger eller samarbejdspartnere ser billedet fra den tekniske direktørs sommerferie på Bali frem for et professionelt billede. Serier af gode portrætter af alle medlemmer af ledelsen og andre udadvendte personer i organisationen sikrer, at de billeder, der dukker frem ved en billedgoogling, er nogle, der harmonerer med organisationens selvbillede. Jeg yder gerne vejledning i at finde de centrale steder på nettet, hvor sådanne billeder bør forefindes.</p>
                    <h4 style="font-weight:300;">Medarbejderne</h4>
                    <p>Det forekommer umiddelbart helt urimeligt dyrt at hyre en professionel fotograf ind, hver gang der ansættes en ny medarbejder. Men jeg indgår gerne rammeaftaler, hvor jeg kommer fast et antal gange om året og tager billeder af alle nyansatte. Gode portrætter vil anspore medarbejdere til at bruge disse flittigt, bl.a. på LinkedIn. Det reflekterer positivt tilbage på virksomheden og er en fin gave til medarbejderne, som ikke beskattes.</p>
                    </div>
                    <!--<hr class="m-t-b-40">-->
                    
                    <div class="contact-info" style="border-left:0;">
                    <h4><span style="border-bottom:1px solid #e8e8e8;padding-bottom: 3px;margin-bottom:12px;">Det personlige portræt</span></h4>
                    
                    <p>Uanset om du er politiker, skuespiller eller forfatter, så ved du, at gode pressebilleder er meget vigtigt. Jeg bruger lang tid på mine portrætter, ikke mindst på at tale med den portrætterede, så jeg er sikker på, at jeg får fat i det rigtige, når jeg begynder at tage billederne. Du får ikke altid det, du troede, du ville have, men noget der er bedre! Og vi skal ikke diskutere, om du skal stå på hænder på dit skrivebord eller have pjaskvådt hår, for sådan arbejder jeg ikke.</p>
...
<!--<script type="text/javascript">
   jQuery(document).ready(function() {
	...
	<!-- /javascript Plugins-->
   	 <?php include ("../includes/brogaard_footer1.php"); ?>
