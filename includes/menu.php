    ...
    <nav class="navbar navbar-inverse">
      <div class="container">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="http://www.brogaard.com/index.php"> <img src="<?php echo $siteurl;?>assets/img/logo.png"></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-3">
          ...
          <ul class="nav navbar-nav navbar-right" style="padding-top:6px">
          	<?php if($menupath=='portfolio'){ ?>
            	<li class="active"><a href="http://www.brogaard.com/shell/galleryindex.php">Tales</a></li>
            <?php }	else {?>
            	<li><a href="http://www.brogaard.com/shell/galleryindex.php">Tales</a></li>
            <?php }?>
            
            <?php /*if($menupath=='royal'){ ?>
            <li class="active"><a href="http://www.brogaard.com/shell/royal.php">Royal</a></li>
            <?php }	else {?>
            <li><a href="http://www.brogaard.com/shell/royal.php">Royal</a></li>
             <?php } */ ?>
            
            <?php /* if($menupath=='scrapbook'){ ?>
            <li class="active"><a href="http://www.brogaard.com/shell/about.php">Scrapbook</a></li>
            <?php }	else {?>
            <li><a href="http://www.brogaard.com/shell/about.php">Scrapbook</a></li>
             <?php }*/ ?>
             
             <?php if($menupath=='services'){ ?>
            <li class="active"><a href="http://www.brogaard.com/shell/services.php">Mission Statement</a></li>
             <?php } else {?>
              <li><a href="http://www.brogaard.com/shell/services.php">Mission Statement</a></li>
               <?php }?>
             <?php if($menupath=='store'){ ?>  
            <li class="active"><a href="http://www.brogaard.com/shell/store_cs.php">Store</a></li>
             <?php } else {?>
            <li><a href="http://www.brogaard.com/shell/store_cs.php">Store</a></li>
             <?php }?>
            <?php if($menupath=='contact'){ ?>  
            <li class="active"><a href="http://www.brogaard.com/shell/contact.php">Contact</a></li>
             <?php } else {?>
...
?>
        	...
        	<?php } else {?>
				<?php if($menupath=='login'){ ?>  
                <li class="active"><a href="http://www.brogaard.com/shell/login.php">Login</a></li>
                 <?php } else {?>
...
?>
             <div id="nv2" style="display:none;">
                <li class="d-none"><a href="<?php echo URL_USER; ?>edit_account.php"><img src="<?php echo $siteurl;?>images/ic_account.png" title="Din konto"  /></a></li>
                <li class="d-none"><a href="<?php echo $clientGalleryHome.'/pdf.php'; ?>"><img src="<?php echo $siteurl;?>images/ic_pdf_1.png" title="PDF" /></a></li>
				<li class="d-none"><a href="<?php echo $clientGalleryHomeHD; ?>"><img src="<?php echo $siteurl;?>images/download-gray.png" title="Download"> </a></li>
                <li class="d-none"><a class="l-1" href="<?php echo $clientGalleryHome; ?>"><img src="<?php echo $siteurl;?>images/ic_commitee.png" title="Udvalg"></a></li>
               </div>
              <?php
}
	  ?>
...
?>
      <div id="afl-menu" class="container-fluid" style="padding:0!important; display:block;">
         <ul id="nav2"  class="navbar-nav nav"><!--id="nav2"-->
            <div >
                <li><a href="<?php echo URL_USER; ?>edit_account.php"><img src="<?php echo $siteurl;?>images/ic_account.png" title="Din konto" /></a></li>
                <li><a href="<?php echo $clientGalleryHome.'/pdf.php'; ?>" alt="PDF"  ><img src="<?php echo $siteurl;?>images/ic_pdf_1.png" alt="PDF" title="PDF" /></a></li>
				<li><a href="<?php echo $clientGalleryHomeHD; ?>" ><img src="<?php echo $siteurl;?>images/download-gray.png" title="Download"></a></li>
                <li><a href="<?php echo $clientGalleryHome; ?>"><img src="<?php echo $siteurl;?>images/ic_commitee.png" title="Udvalg"></a></li>
            <div>
         </ul>
      </div>
      <?php
