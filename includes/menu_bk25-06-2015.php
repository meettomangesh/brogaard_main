...
?>
             <div id="nv2" style="display:none;">
                <li class="d-none"><a href="<?php echo URL_USER; ?>edit_account.php"><img src="<?php echo $siteurl;?>images/ic_account.png" title="Your Account"  /></a></li>
                ...
                <li class="d-none"><a class="l-1" href="<?php echo $clientGalleryHome; ?>"><img src="<?php echo $siteurl;?>images/ic_commitee.png" title="Committee"></a></li>
               </div>
              <?php
}
	  ?>
...
?>
      <div id="afl-menu" class="container-fluid" style="padding:0!important; display:block;">
         <ul id="nav2"  class="navbar-nav nav"><!--id="nav2"-->
            <div >
                <li><a href="<?php echo URL_USER; ?>edit_account.php"><img src="<?php echo $siteurl;?>images/ic_account.png" title="Your Account" /></a></li>
                ...
                <li><a href="<?php echo $clientGalleryHome; ?>"><img src="<?php echo $siteurl;?>images/ic_commitee.png" title="Committee"></a></li>
            <div>
         </ul>
      </div>
      <?php
