        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-3">
          ...
          <ul class="nav navbar-nav navbar-right" style="padding-top:6px">
          	<?php if($menupath=='portfolio'){ ?>
            	<li class="active"><a href="http://www.brogaard.com/shell/galleryindex.php">Portfolio</a></li>
            <?php }	else {?>
            	<li><a href="http://www.brogaard.com/shell/galleryindex.php">Portfolio</a></li>
            <?php }?>
            
            <?php if($menupath=='royal'){ ?>
            <li class="active"><a href="http://www.brogaard.com/shell/info.php">Royal</a></li>
            <?php }	else {?>
            ...
            <li class="active"><a href="http://www.brogaard.com/shell/services.php">Services</a></li>
             <?php } else {?>
